...
openssl ca -config /root/ca/intermediate/openssl_intermediate.cnf -extensions server_cert -startdate $sdate -enddate $cedate -notext -md sha512 -in /root/ca/intermediate/csr/$domain.csr -out /root/ca/intermediate/certs/$domain.crt -passin pass:${CERT_PASSWORD} -batch
openssl pkcs12 -inkey /root/ca/intermediate/private/$domain.key -in /root/ca/intermediate/certs/$domain.crt -export -chain -CAfile /root/ca/intermediate/certs/chain.globalcert.com.crt.pem -out /root/ca/intermediate/certs/$domain.p12 -passout pass:${CERT_PASSWORD} $addalias
...
EOM
  ...
  openssl ca -config /root/ca/intermediate/openssl_intermediate.cnf -startdate $sdate -enddate $cedate -notext -md sha512 -in /root/ca/intermediate/csr/cs.$domain.csr -out /root/ca/intermediate/certs/cs.$domain.crt -passin pass:${CERT_PASSWORD} -batch
  openssl pkcs12 -inkey /root/ca/intermediate/private/cs.$domain.key -in /root/ca/intermediate/certs/cs.$domain.crt -export -chain -CAfile /root/ca/intermediate/certs/chain.globalcert.com.crt.pem -out /root/ca/intermediate/certs/cs.$domain.p12 -passout pass:${CERT_PASSWORD} $addalias
